...
import com.dxj.skc.common.util.CommUtils;
...
public class LimitAspect {
    ...
    @Pointcut("@annotation(com.dxj.skc.limit.annotation.Limit)")
    ...
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        ImmutableList<Object> keys = ImmutableList.of(StringUtils
                .join(limit.prefix(), "_", key, "_", request.getRequestURI().replaceAll("/", "_")));
